...
func adminRoutes(router *chi.Mux, app *app.Application) {
	...
	router.Route("/admin", func(r chi.Router) {
		...
		r.Get("/recharge-kit/primary-balance", app.PayoutHandler.HandleGetBoompayWalletBalance)
		...
		r.Get("/boom/balance", app.PayoutHandler.HandleGetBoompayWalletBalance)
...
func fundTransferRoutes(router *chi.Mux, app *app.Application) {
	router.Route("/fund-transfer", func(r chi.Router) {
		...
		r.Post("/md-to-md", app.FundTransferHandler.HandleMDToDistributor)
		...
		r.Post("/distributor-to-distributor", app.FundTransferHandler.HandleDistributorToRetailer)
...
func aepsRoutes(router *chi.Mux, app *app.Application) {
	router.Route("/aeps", func(r chi.Router) {
		...
		r.Post("/check/dailylogin/{id}", app.AEPSHandler.CheckAEPSDailyLoginStatus)
